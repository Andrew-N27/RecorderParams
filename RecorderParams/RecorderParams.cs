...
namespace RecorderParams
{
    public class myRecorderParams
    {
        public myRecorderParams(string filename, int FrameRate, FourCC Encoder, int Quality)
        {
            FileName = filename;
    ...
    public class Recorder : IDisposable
    {
        #region Fields
        AviWriter writer; 
        myRecorderParams Params;
        IAviVideoStream videoStream;
        Thread screenThread;
        ManualResetEvent stopThread = new ManualResetEvent(false);
        #endregion

        public Recorder(myRecorderParams Params)
        {
            this.Params = Params;
